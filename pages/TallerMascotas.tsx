    ...
    modulos={[
      {
        ...
        bloques: [
          ...
          { time: '', title: 'Flores de Bach para tu mascota', desc: 'Las 7 flores esenciales para animales, cuándo usar cada una, cómo administrarlas de forma segura y un ejercicio guiado para seleccionar la fórmula personalizada de tu mascota.' },
      ...
      },
      {
        ...
        bloques: [
          ...
          { time: '', title: 'Pares biomagnéticos para mascotas', desc: 'Pares de regulación general adaptados a animales. Aprenderás los principios de aplicación y verás una demostración completa del proceso de rastreo.' },
