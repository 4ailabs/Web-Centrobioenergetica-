...
const OndaSvg = ({ size = 40, color = AZ, opacity = 0.8 }: { size?: number; color?: string; opacity?: number }) => (
    ...
    <div className="w-full pt-[72px] lg:pt-0 pb-16 overflow-x-hidden" style={{ fontFamily: S, background: BG }}>
      ...
      <div className="relative overflow-hidden rounded-xl mx-6 lg:mx-0" style={{ minHeight: 280, background: BK }}>
        ...
        <div className="relative z-10 flex flex-col justify-center py-12 px-8" style={{ minHeight: 280 }}>
          ...
          <p className="mt-4 max-w-sm" style={{ fontSize: 14, color: '#E8EEF4', opacity: 0.55, lineHeight: 1.5 }}>
            Taller completo · Sábado 11 de abril · 10:00 – 18:00 h
          </p>
        </div>
      ...
      <div className="px-6 lg:px-0 pb-8">
        <div className="flex flex-wrap gap-3 mb-4">
          <div className="flex items-center gap-3 px-4 py-3 rounded-lg" style={{ background: CIELO }}>
            ...
            <div>
              <p className="text-[14px] font-medium" style={{ color: BK }}>Sábado 11 de abril</p>
              <p className="text-[12px]" style={{ color: GR }}>10:00 – 18:00 h · Jornada completa</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap gap-2 mb-3">
          <div className="px-4 py-2 rounded-lg text-center" style={{ background: '#fff', border: `1px solid ${CR}` }}>
            <p className="text-[13px] font-semibold" style={{ color: AZ }}>$1,800 MXN</p>
            <p className="text-[11px]" style={{ color: GR }}>Presencial con diapasón</p>
          </div>
          <div className="px-4 py-2 rounded-lg text-center" style={{ background: '#fff', border: `1px solid ${CR}` }}>
            <p className="text-[13px] font-semibold" style={{ color: BK }}>$1,500 MXN</p>
            <p className="text-[11px]" style={{ color: GR }}>Presencial sin diapasón</p>
          </div>
          <div className="px-4 py-2 rounded-lg text-center" style={{ background: '#fff', border: `1px solid ${CR}` }}>
            <p className="text-[13px] font-semibold" style={{ color: BK }}>$1,500 MXN</p>
            <p className="text-[11px]" style={{ color: GR }}>Online</p>
          </div>
        </div>

        <div className="flex flex-wrap gap-2">
          <span className="text-[13px] px-3 py-1 rounded-md" style={{ background: CIELO, color: AZ }}>Cupo presencial: 20 personas</span>
      ...
      <div className="px-6 lg:px-0 pb-10">
        <div className="p-6 rounded-xl" style={{ background: CIELO_L, border: `1px solid ${CR}` }}>
          ...
          <p className="mt-2 text-[13px]" style={{ color: GR }}>Todo público · Sin requisitos · Presencial y Online</p>
        </div>
      </div>
      ...
      <div className="px-6 lg:px-0 pb-10">
        ...
        <div className="space-y-4">
          {bloques.map((b, bi) => {
            ...
            return (
              <div key={bi} className="rounded-xl overflow-hidden transition-shadow hover:shadow-md" style={{ background: '#fff', border: '1px solid #E2EAF0' }}>
                ...
                {isOpen && (
                  <div style={{ borderTop: '1px solid #EEF3F7' }}>
                    {b.temas.map(([title, desc], ti) => (
                      <div key={ti} className="flex gap-3 px-5 py-3.5" style={{ borderBottom: ti < b.temas.length - 1 ? '1px solid #F5F8FB' : 'none' }}>
        ...
        <div className="py-10 px-6" style={{ background: CIELO_L }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-2xl mx-auto">
            {[
              ...
              <div key={i} className="flex gap-3 p-4 rounded-lg" style={{ background: '#fff', border: `1px solid ${CR}` }}>
      ...
      <div className="px-6 lg:px-0 pb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {[
            { cat: 'Presencial', accent: AZ, items: [
              'Diapasón Auto 128 Hz — lo usas el domingo',
              'Tu piedra — el objeto transformado del taller',
              'Los pedazos de hilo roto — evidencia del acto',
            ]},
            { cat: 'Todos los participantes', accent: AZL, items: [
            ...
            <div key={gi} className="p-5 rounded-xl" style={{ background: '#fff', border: '1px solid #E2EAF0' }}>
      ...
      <div className="px-6 lg:px-0 pb-6">
        <a
          href="https://wa.me/525579076626?text=Hola%2C%20quiero%20inscribirme%20a%20Resonantia%20%E2%80%94%20Diapasones%20Terapeuticos"
          target="_blank"
        ...
        <p className="text-center mt-3 text-[13px]" style={{ color: GR }}>
          Presencial · Cupo limitado a 20 personas · Sábado 11 de abril
        </p>
      </div>
