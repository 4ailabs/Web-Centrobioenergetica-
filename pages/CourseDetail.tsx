      ...
      <div className="px-6 lg:px-0 pb-6 flex flex-col lg:flex-row gap-5">
        ...
        <div className="flex-1 min-w-0">
          {activeVideo ? (
            ...
            <div>
              <div className="rounded-xl overflow-hidden aspect-video relative bg-neutral-100 dark:bg-neutral-800">
                ...
                {hasAccess && totalVideos > 0 && (
                  <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <span className="text-white text-xs font-medium">{totalVideos} videos</span>
                    </div>
                  </div>
                )}
              </div>
