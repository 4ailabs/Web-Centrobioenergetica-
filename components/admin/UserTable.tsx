                    ...
                    >
                        <div className="flex-1 min-w-[180px]">
                            <div className="flex items-center gap-2 flex-wrap">
                                ...
                                {isCurrentUser && <span className="text-[10px] text-neutral-600 dark:text-neutral-400">(tú)</span>}
                                {suspendido && (
                                    <Badge tono="atencion" icono={<UserMinus className="w-2.5 h-2.5" />}>Sin acceso</Badge>
                                )}
                            </div>
                            <p className="text-[12.5px] text-neutral-600 dark:text-neutral-400 mt-0.5 truncate">{user.email}</p>
                            ...
                            {cursos.length === 0 ? (
                                ...
                                <p className="mt-2 text-[12.5px] text-neutral-600 dark:text-neutral-300 leading-relaxed">
                                    <BookOpen className="w-3 h-3 inline-block mr-1 -mt-0.5 text-neutral-600 dark:text-neutral-400" />
