...
const AppCard: React.FC<AppCardProps> = ({ app }) => {
  return (
    <div className="bg-[var(--panel-bg)] rounded-3xl p-8 flex flex-col h-full hover:bg-primary-500/5 transition-all duration-200 border border-zinc-200/80 dark:border-white/10 hover:border-primary-500/30 group shadow-sm hover:shadow-lg hover:shadow-primary-500/5">
