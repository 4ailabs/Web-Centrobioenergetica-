...
const CourseCard: React.FC<CourseCardProps> = memo(({ course, onCourseClick }) => {
  ...
  return (
    <div
      onClick={handleClick}
      className="group relative bg-[var(--panel-bg)] rounded-3xl overflow-hidden border border-zinc-200/80 dark:border-white/10 shadow-sm hover:shadow-xl hover:shadow-primary-600/5 dark:hover:shadow-primary-600/10 transition-all duration-300 cursor-pointer flex flex-col h-full hover:border-primary-500/20"
    >
      {/* Image Container */}
