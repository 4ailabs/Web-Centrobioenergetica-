...
const NewsCard: React.FC<NewsCardProps> = ({ article }) => {
  ...
  return (
    <div className="bg-[var(--panel-bg)] rounded-[2.5rem] overflow-hidden border border-zinc-200/80 dark:border-white/10 shadow-sm hover:shadow-xl hover:shadow-primary-600/5 dark:hover:shadow-primary-600/10 transition-all duration-300 flex flex-col group h-full hover:border-primary-500/20">
