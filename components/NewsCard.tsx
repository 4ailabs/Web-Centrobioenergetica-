...
const NewsCard: React.FC<NewsCardProps> = ({ article }) => {
  ...
  return (
    <div className="bg-[var(--panel-bg)] rounded-[2.5rem] overflow-hidden border border-[var(--border-color)] shadow-sm hover:shadow-2xl transition-all duration-500 flex flex-col hover:-translate-y-2 group h-full">
